...
public partial class StreamPlayerControl
{
    ...
    private static readonly DependencyPropertyKey IsPlayingPropertyKey =
        DependencyProperty.RegisterReadOnly("IsPlaying", typeof(bool), typeof(StreamPlayerControl),
    ...
    private StreamPlayerProxy Player
    {
        get
        {
            if (_player == null) _player = CreateAndInitializePlayer();
    ...
    /// </summary>
    [Browsable(false)]
    public Size VideoSize => IsPlaying ? Player.GetFrameSize() : new Size(0, 0);
    ...
    {
        if (!IsPlaying) throw new InvalidOperationException();
    ...
    private void HandleWindowClosed(object sender, EventArgs eventArgs)
    {
        ...
        if (window != null) window.Closed -= HandleWindowClosed;
    }

    protected override void OnContentChanged(object oldContent, object newContent)
    {
        if (oldContent != null) throw new InvalidOperationException();
    }
