...
For a complete example of using the StreamPlayerCore WPF control, please refer to the [StreamPlayerCore.WPF.Demo](https://github.com/BlazekWasTaken/StreamPlayerCore/tree/main/StreamPlayerCore.WPF.Demo) project.
