...
namespace FFmpeg::Facade
{
    class Stream;

    using StreamStartedCallback = void(__stdcall *)();
    using StreamStoppedCallback = void(__stdcall *)();
    using StreamFailedCallback = void(__stdcall *)(const char* error);
    ...
    /// </summary>
    class StreamPlayer : boost::noncopyable
    {
    public:
        /// <summary>
