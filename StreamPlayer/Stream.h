...
#pragma warning( pop )
    ...
    // x86: ./configure --toolchain=msvc --arch=i686 --enable-version3 --enable-static --disable-shared --disable-programs --disable-doc 
...
#pragma comment(lib, "ncrypt.lib")
    ...
    namespace Facade
    {
        ...
        private:
            ...
            double GetTimestamp(const AVFrame* avframePtr, const AVRational& timeBase);
